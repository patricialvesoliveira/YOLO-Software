...
class AffectiveIdleBehavior(ComposedBehavior):
    def __init__(self, bodyRef):
        ...
        self.behaviorList.append(BlinkBehaviorEaseIn(bodyRef, [Color(rgb=(1.0, 0.55, 0.0)), Color(rgb=(0.0, 0.0, 0.0))], ColorBrightness.MEDIUM, 1.0, 1.0, bodyRef.getColor(), True))