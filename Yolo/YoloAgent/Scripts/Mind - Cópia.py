...
class Mind:
    ...
    def __init__(self, personality, body):
        ...
        self.testBehavior = PunkAttentionCallBehavior(self.body)
        return
    ...
    def update(self):
        ...
        # if(self.body.getTouchSensorState() == TouchState.TOUCHING and not self.wasTouched):
        #     print "touching"
        #     self.wasTouched = True
        #     self.testBehavior = AffectiveBehavior1(self.body)
