...
class LoopsSlowBehavior(ComposedBehavior):
    def __init__(self, bodyRef):
        ...
        # generic variables
        self.behaviorType = ComposedBehaviors.LOOPS_SLOW
        self.behaviorList.append(MoveBehavior(bodyRef, Shapes.LOOPS, 45, MovementDirection.STANDARD, Transitions.LINEAR, 1, 5, True))
