...
LED_DMA = 5  # DMA channel to use for generating signal (Between 1 and 14)
LED_INVERT = False  # True to invert the signal (when using NPN transistor level shift)
LED_BRIGHTNESS = 255     # Set to 0 for darkest and 255 for brightest
LED_CHANNEL = 1  # PWM 0 or 1
...
# And ws.SK6812_STRIP_GRBW can be used for some GRBW wires
...
class StripLEDActuator:
    ...
    def __del__(self):
        ...
        print "Turning off the strip's LEDs"
    ...
    def printColor(self, ledColorData):
        ...
        print "Strip LEDs color: " + str(red) + ", " + str(green) + ", " + str(blue)
