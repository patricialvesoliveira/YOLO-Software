...
puppeteerBehavior = ComposedBehavior(bodyRef,[BlinkBehaviorEaseInOut(bodyRef, Color(rgb=(0.9,0.9,0.9)), ColorBrightness.LOW, 0, 1.0, Color(rgb=(0.0, 0.0, 0.0)))])

idleBehavior = ComposedBehavior(bodyRef, [BlinkBehaviorEaseInOut(bodyRef,  Color(rgb=(0.9,0.9,0.9)), ColorBrightness.LOW, 1, 2.0, Color(rgb=(1.0, 0.4, 0.0))])

bugsBunnyGeneralProfile = GeneralProfile("BugsBunnyGeneral", helloBehavior, goodbyeBehavior, puppeteerBehavior, idleBehavior)


attentionCallBehavior = ComposedBehavior(bodyRef, [BlinkBehaviorInstant(bodyRef, Color(rgb=(0.9,0.9,0.9)), ColorBrightness.HIGH, 4, 2.0, Color(rgb=(0.0, 0.0, 0.0)))])


behaviorList = []
behaviorList.append(BlinkBehaviorEaseInOut(bodyRef, Color(rgb=(0.9,0.9,0.9)), ColorBrightness.LOW, 1, 4.0, Color(rgb=(0.0, 0.0, 0.0))))
...
agent.interact(personalityProfile = bugsBunnyGeneralProfile, generalProfile=bugsBunnyPersonalityProfile, creativityProfile = bugsBunnyCreativityProfile)